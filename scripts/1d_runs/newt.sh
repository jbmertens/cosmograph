...
do
  ...
  ../../scripts/1d_runs/1d_runs.sh -C -N=0064 -A=$A -l=$L -g=GeneralizedNewton --GN_eta=0.02
  ../../scripts/1d_runs/1d_runs.sh -C -N=0096 -A=$A -l=$L -g=GeneralizedNewton --GN_eta=0.02
  ../../scripts/1d_runs/1d_runs.sh -C -N=0128 -A=$A -l=$L -g=GeneralizedNewton --GN_eta=0.02
done
